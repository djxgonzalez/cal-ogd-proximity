##============================================================================##
## 3.01 - determines risk ratios for exposure to wells in each stage stratified
## by racial/ethnic and socioeconomic indicators
...
##--------------------------------------------------------------------------
## exports table
write_csv(table_rr, file = "output/results/table_rr.csv")

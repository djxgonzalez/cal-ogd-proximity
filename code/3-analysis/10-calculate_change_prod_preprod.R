##============================================================================##
## 3.07 - determines the racial/ethnic composition of block groups where 
...
data <- readRDS("data/processed/acs_exposure_2005_2019.rds") %>%
  ...
  mutate(prod_volume_0_1km = ifelse(is.na(prod_volume_0_1km), 0, 
                                    prod_volume_0_1km),
         preprod_wells_0_1km = ifelse(is.na(preprod_wells_0_1km), 0, 
                                      preprod_wells_0_1km))
...
colnames(data_2010_2014) <- paste(colnames(data_2010_2014), "2010_2014",
                                  sep = "_")
colnames(data_2015_2019) <- paste(colnames(data_2015_2019), "2015_2019", 
                                  sep = "_")

data <- merge(data_2010_2014, data_2015_2019,
              by.x = "GEOID_2010_2014", by.y = "GEOID_2015_2019") %>%
  mutate(group_prod = ifelse(prod_volume_0_1km_2015_2019 > 
                               prod_volume_0_1km_2010_2014, "increased",
                             ifelse(prod_volume_0_1km_2015_2019 < 
                                      prod_volume_0_1km_2010_2014, 
                                    "decreased", "same")),
         group_preprod = ifelse(preprod_wells_0_1km_2015_2019 > 
                                  preprod_wells_0_1km_2010_2014, "increased",
                                ifelse(preprod_wells_0_1km_2015_2019 < 
                                         preprod_wells_0_1km_2010_2014, 
                                       "decreased", "same")),
         change_prod = (prod_volume_0_1km_2015_2019 - 
                          prod_volume_0_1km_2010_2014),
         change_preprod = (preprod_wells_0_1km_2015_2019 - 
                             preprod_wells_0_1km_2010_2014))
...
preprod <- data %>%
  ...
  mutate(pop_other_2015_2019 = 
           rowSums(cbind(pop_nonhisp_am_indian_2015_2019,

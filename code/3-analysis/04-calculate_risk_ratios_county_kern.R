##============================================================================##
## 3.04 - estimates  risk ratios for exposure to wells in
## preproduction, production, or postproduction for racial/ethnic and
## socioeconomic groups, stratified by time period for *Kern County*
...
acs_exposure_2005_2009 <- acs_exposure_2005_2019 %>%
  ...
  filter(county == "029")  # selects Kern county (FIPS code 029)
...
##--------------------------------------------------------------------------
## exports table
write_csv(table_rr, file = "output/results/table_rr_county_kern.csv")

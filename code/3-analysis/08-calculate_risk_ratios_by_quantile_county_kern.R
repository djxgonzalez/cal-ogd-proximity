##============================================================================##
## 3.08 - determines risk ratios for exposure to wells in each stage stratified
## by racial/ethnic and socioeconomic indicators - also stratified by quantile
## of exposure - restricted to Kern County
...
acs_exposure_2005_2019 <- 
  ...
  filter(substr(GEOID, 1, 5) == "06029")  # restricts to Kern County
...
write_csv(table_rr_quantiles, 
          file = "output/results/table_rr_quantiles_county_kern.csv")

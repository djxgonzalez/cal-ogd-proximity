##============================================================================##
## 3.05 - determines risk ratios for exposure to wells in each stage stratified
...
# exports table
write_csv(table_rr_quantiles, file = "output/results/table_rr_quantiles.csv")

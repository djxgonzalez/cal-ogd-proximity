##============================================================================##
## 3.02 - estimates with risk ratios for exposure to wells in
## preproduction, production, or postproduction for racial/ethnic and
## socioeconomic groups, stratified by time period for Los Angeles County
...
acs_exposure_2005_2009 <- acs_exposure_2005_2019 %>%
  ...
  filter(county == "037")  # selects Los Angles county (FIPS code 037)
...
##--------------------------------------------------------------------------
## exports table
write_csv(table_rr, file = "output/results/table_rr_county_losangeles.csv")

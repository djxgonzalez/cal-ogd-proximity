##============================================================================##
## makes Figure S11 - like Figure S1 but for SES indicators, restricted to
## Orange County
...
table_quantiles_prod_vol <- 
  read_csv("output/results/table_rr_quantiles_county_orange.csv") %>%
...
figure_s11a <- table_quantiles_prod_vol %>%
...
ggsave(filename = "figure_s11a.png", plot = figure_s11a, device = "png",

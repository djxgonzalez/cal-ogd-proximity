##============================================================================##
## makes Figure S14 - like Figure S1 but for SES indicators, restricted to
## Kern County
...
table_quantiles_prod_vol <- 
  read_csv("output/results/table_rr_quantiles_county_kern.csv") %>%
...
figure_s14a <- table_quantiles_prod_vol %>%
...
ggsave(filename = "figure_s14a.png", plot = figure_s14a, device = "png",
